...
for mouse_name, ax in zip(position.individual.values, axes, strict=False):
    ax.invert_yaxis()
...
ax.quiver(
    position.sel(individual=mouse_name, space="x"),
    position.sel(individual=mouse_name, space="y"),
    displacement.sel(individual=mouse_name, space="x"),
    displacement.sel(individual=mouse_name, space="y"),
    angles="xy",
    scale=1,
    scale_units="xy",
    headwidth=7,
...
ax.quiver(
    position.sel(individual=mouse_name, space="x"),
    position.sel(individual=mouse_name, space="y"),
    -displacement.sel(individual=mouse_name, space="x"),  # flipped sign
    -displacement.sel(individual=mouse_name, space="y"),  # flipped sign
    angles="xy",
    scale=1,
    scale_units="xy",
    headwidth=7,
...
displacement_vectors_lengths = compute_norm(
    displacement.sel(individual=mouse_name)
)
