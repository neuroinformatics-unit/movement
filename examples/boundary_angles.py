...
# two-dimensional, we will use a
# :class:`PolygonOfInterest<movement.roi.polygon.PolygonOfInterest>`
...
#
# One other thing to note is that :meth:`compute_distance_to<movement.roi.\
# polygon.PolygonOfInterest.compute_distance_to>` is returning the distance
# "as the crow flies" to the ``nest_region``. This means that
...
# to as the **approach vector**, we can use the
# :meth:`compute_approach_vector<movement.roi.polygon.PolygonOfInterest.\
# compute_approach_vector>` method.
# The distances that we computed via :meth:`compute_distance_to<movement.roi.\
# polygon.PolygonOfInterest.compute_distance_to>` are just the
...
# Note that for 1D regions
# (:class:`LineOfInterest<movement.roi.line.LineOfInterest>`),
...
# :func:`movement.kinematics.compute_velocity<movement.kinematics.\
# kinematics.compute_velocity>`.
