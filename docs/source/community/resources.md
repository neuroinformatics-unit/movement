...
<div class="colour-grid">
    <div class="colour-card">
        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100">
            <circle cx="50" cy="50" r="50" fill="#66c2a5"/>
        </svg>
        <b style="color: #66c2a5;">Green Sheen</b><br/>
        RGB: 102 194 165<br/>
        HEX: #66c2a5
    </div>
    <div class="colour-card">
        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100">
            <circle cx="50" cy="50" r="50" fill="#8da0cb"/>
        </svg>
        <b style="color: #8da0cb;">Ceil</b><br/>
        RGB: 141 160 203<br/>
        HEX: #8da0cb
    </div>
    <div class="colour-card">
        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100">
            <circle cx="50" cy="50" r="50" fill="#fc8d62"/>
        </svg>
        <b style="color: #fc8d62;">Atomic Tangerine</b><br/>
        RGB: 252 141 98<br/>
        HEX: #fc8d62
    </div>
</div>
