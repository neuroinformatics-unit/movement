...
from movement.kinematics.body_axis import run_ap_validation
...
def compute_polarization(
    ...
    in_degrees : bool, default=False
        ...
        ``return_angle=True``.
    validate_ap : bool, default=False
    ...
    ap_validation_config : dict, optional
        ...
        See ``movement.kinematics.body_axis.ValidateAPConfig`` for options.
    ...
    if normalized_keypoints is not None:
        if validate_ap:
            ap_validation_result = run_ap_validation(
