...
from movement.kinematics.orientation import compute_turning_angle
...
def compute_directional_change(
    ...
    >>> dc = compute_directional_change(centroid, start=0, stop=100)
    ...
    """
    data = _slice_and_validate(data, start, stop, "directional change")
