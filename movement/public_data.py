...
PUBLIC_DATASETS = {
    "calms21": {
        "description": "Multi-animal behavior dataset for unsupervised behavior classification",
        "url": "https://data.caltech.edu/records/g6fjs-ceqwp",
        "paper": "https://doi.org/10.1038/s41592-022-01426-1",
        "license": "CC-BY-4.0",
    },
    "rat7m": {
        "description": "Multi-animal tracking dataset of rats in complex environments",
...
def fetch_calms21(
    ...
    animal types and tasks. This function fetches a specific subset of the data.
    ...
    if animal_type not in valid_animal_types:
        raise log_error(
            ValueError,
            f"Invalid animal type: {animal_type}. Must be one of {valid_animal_types}",
        )
    ...
    logger.info(
        f"Fetching CalMS21 data: {animal_type}/{task}/{subset}"
    )
...
def fetch_rat7m(
    ...
    .. [1] Dunn et al. (2021). "Geometric deep learning enables 3D kinematic
       profiling across species and environments". Nature Methods, 18(5), 564-573.
