...
from movement.datasets import fetch_pose_data
...
class TestLoadPoses:
    ...
    def valid_dlc_files(self):
        ...
        """
        h5_file = fetch_pose_data("DLC_single-wasp.predictions.h5")
        csv_file = fetch_pose_data("DLC_single-wasp.predictions.csv")
        return {
            "h5_path": h5_file,
